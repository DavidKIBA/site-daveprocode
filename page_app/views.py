...
def contact_page(request):
    return render(request, 'other_page/contact.html')

def formation_page(request):
    return render(request, 'other_page/formation.html')

def service_page(request):
    return render(request, 'other_page/services.html')

def handle404(request, exception):
    return render(request, 'other_page/404.html')
