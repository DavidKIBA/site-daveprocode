...
<script>
  ...
  {$(".toggle-text").click(function () {
    ...
    if ($text.hasClass("expanded")) {
      $text.text(
        "Création de stratégies de contenu personnalisées, du marketing engageant aux campagnes sur les réseaux sociaux, pour renforcer la notoriété de votre marque."
      );
...
// Ajout d'un écouteur d'événement sur le lien pour ouvrir le modal
termsLink.addEventListener("click", openModal);

// Ajout d'un écouteur d'événement sur le bouton de fermeture du modal
